 ...
 * @author Kevin Wayne
 */
public class BSTPrinceton<Key extends Comparable<Key>, Value> implements TreeInterface<Key, Value> {
...
class TestBSTPrinceton {
    ...
    private static void insertKV(BSTPrinceton<Integer, Integer> splayTree, Integer key, Integer value) {
        myAssert(!splayTree.contains(key));
        splayTree.put(key, value);
        myAssert(splayTree.contains(key));
    }

    private static void deleteK(BSTPrinceton<Integer, Integer> splayTree, Integer key) {
        myAssert(splayTree.contains(key));
