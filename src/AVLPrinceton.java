...
public class AVLPrinceton<Key extends Comparable<Key>, Value> implements TreeInterface<Key, Value>{
    ...
    //     AVLPrinceton<String, Integer> st = new AVLPrinceton<String, Integer>();
